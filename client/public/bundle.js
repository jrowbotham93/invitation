/******/ (() => {
  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (
      ...
      /* harmony import */ var _index_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        4
      );
      /* harmony import */ var _index_html__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
        _index_html__WEBPACK_IMPORTED_MODULE_2__
      );
      /* harmony import */ var _styles_app_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        5
      );
      /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        9
      );
      /* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        11
      );
      /* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        12
      );
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 2:
                        ...
                        _globals__WEBPACK_IMPORTED_MODULE_6__.checkboxPlusOne.addEventListener(
                          'change',
                          function (event) {
                            var bool = (0,
                            _utils__WEBPACK_IMPORTED_MODULE_4__.validateCheckboxInput)(
                            ...
                            (0,
                            _render__WEBPACK_IMPORTED_MODULE_5__.renderPlusOneInputField)(
                              bool
                            );
                          }
                        );
...
*/
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ getTotalAttendees: () =>
          /* binding */ getTotalAttendees,
        /* harmony export */
      });
      /* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        10
      );
      /* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        11
      );
      ...
      _state__WEBPACK_IMPORTED_MODULE_0__.attendeeState.registerNewListener(
        function (val) {
          return (0, _render__WEBPACK_IMPORTED_MODULE_1__.renderAttendeesCount)(
            val
          );
        }
      );
    ...
    /***/ (
      ...
      var attendeeState = {
        ...
        registerNewListener: function registerNewListener(
          externalListenerFunction
        ) {
    ...
    /***/ (
      ...
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ renderAttendeesCount: () =>
          /* binding */ renderAttendeesCount,
        /* harmony export */ renderPlusOneInputField: () =>
          /* binding */ renderPlusOneInputField,
        /* harmony export */ renderAttendeesList: () =>
          /* binding */ renderAttendeesList,
        /* harmony export */
      });
      /* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        12
      );
      ...
      function renderAttendeesCount(count) {
        ...
        var highlightNumber = '<span class="highlightNumber'
          .concat(color, '">')
          .concat(count, '</span>');
        _globals__WEBPACK_IMPORTED_MODULE_0__.attendeeCount.innerHTML = 'Currenly '.concat(
          highlightNumber,
          ' guests confirmed.'
        );
      }
      ...
      var tableRow = function tableRow(attendeeId, data) {
        return '<tr class="attendeeRow" id='
          .concat(attendeeId, '>\n    <td>')
          .concat(data.name, '</td>\n    <td>')
          .concat(
            data.attending
          ...
          var attendeeRows = ''.concat(
            attendees
              .map(function (_ref) {
                var id = _ref.id,
                  data = _ref.data;
                return tableRow(id, data);
              })
              .join('')
          );
          _globals__WEBPACK_IMPORTED_MODULE_0__.attendeeTable.insertAdjacentHTML(
            'beforeend',
            attendeeRows
          );
        }
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ checkboxPlusOne: () =>
          /* binding */ checkboxPlusOne,
    ...
    /***/ (
      ...
      /* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        12
      );
      /* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        11
      );
      /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        9
                ...
                function _callee2$(_context2) {
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        (_config = (0,
                        _globals__WEBPACK_IMPORTED_MODULE_2__.config)()),
                          (url = _config.url);
                        _context2.next = 3;
                        return fetch(url, {
                          method: 'POST',
                                        ...
                                        while (1) {
                                          switch (
                                            ...
                                            case 0:
                                              _context.next = 2;
                                              return (0,
                                              _render__WEBPACK_IMPORTED_MODULE_3__.renderAttendeesList)(
                                                Array(attendee)
                                              );
                                            ...
                                            case 2:
                                              _context.next = 4;
                                              return (0,
                                              _utils__WEBPACK_IMPORTED_MODULE_4__.getTotalAttendees)(
                                                attendee
                                              );
                    ...
                    switch ((_context3.prev = _context3.next)) {
                      ...
                      case 10:
                        res.forEach(function (attendee) {
                          return (0,
                          _utils__WEBPACK_IMPORTED_MODULE_4__.getTotalAttendees)(attendee);
                        });
                ...
                function _callee4$(_context4) {
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        (_config3 = (0,
                        _globals__WEBPACK_IMPORTED_MODULE_2__.config)(id)),
                          (url = _config3.url);
                        _context4.next = 3;
                        return fetch(url, {
                          method: 'PUT',
