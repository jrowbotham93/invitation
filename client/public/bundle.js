...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _index_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
...
/* harmony import */ var _styles_app_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_api__WEBPACK_IMPORTED_MODULE_3__.readAttendees)();

        case 2:
          form = document.querySelector('.attendeeDetailsForm');
          checkboxPlusOne = document.querySelector('.checkboxPlusOne'); // const attendeeCount = document.querySelector('.attendeeCount');

          removeSelectedAttendee = document.querySelector('.removeAttendee');
          ...
          form.addEventListener('formdata', function (event) {
            ...
            dataToPost.attending = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.validateCheckboxInput)(dataToPost.attending);
            dataToPost.plusOne = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.validateCheckboxInput)(dataToPost.plusOne);
            (0,_api__WEBPACK_IMPORTED_MODULE_3__.createAttendee)(dataToPost);
          });
          removeSelectedAttendee.addEventListener('click', function (event) {
            (0,_api__WEBPACK_IMPORTED_MODULE_3__.removeAttendee)(event.target.getAttribute('name'));
          }); // attendeeCount.innerHTML = `Currenly ${attendeeList} guests`;

          checkboxPlusOne.addEventListener('change', function (event) {
            console.log(event);
            var bool = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.validateCheckboxInput)(event.target.value);
            (0,_api__WEBPACK_IMPORTED_MODULE_3__.renderPlusOneInputField)(bool);
          });
...
/* harmony export */   "renderPlusOneInputField": () => /* binding */ renderPlusOneInputField
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
var config = function config(param) {
  return {
    url: "".concat("https://us-central1-wedding-invite-6f11a.cloudfunctions.net/webApi/api/v1/attendees", "/").concat(param ? param : '')
  };
}; //  API calls
...
function renderAttendeesList(attendees) {
  if (attendees.length < 1) return;else {
    var attendeTable = document.querySelector('.attendee-table');
    var htmlTick = '<span class="htmlTick">&#10004</span>';
    var htmlCross = '<span class="htmlCross">&#10007;</span>';
    var attendeeRows = "".concat(attendees.map(function (_ref, key) {
      var id = _ref.id,
          data = _ref.data;
      return "<tr>\n            <td>".concat(data.name, "</td>\n            <td>").concat(data.attending ? htmlTick : htmlCross, "</td>\n            <td>").concat(data.plusOne ? htmlTick : htmlCross, "</td>\n            <td>").concat(data.plusOneName, "</td>\n            <td class=\"removeAttendee\" name=\"").concat(id, "\">\n              Remove attendee\n            </td>\n          </tr>");
    }).join(''));
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_app_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
